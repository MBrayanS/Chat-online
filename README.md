...
O `Lapislazuli Chat` é uma aplicação web de bate papo **open source**. Criado principalmente para por em pratica conhecimentos técnicos e trabalho em equipe. 

O código deste repositório está livre para ser clonado e usado por qualquer pessoa. E se você deseja participar da sua construção, sinta se a vontade para [contribuir](#-contribuição). 
...
## ⚙ Funcionalidades
 ...
 Nesta aplicação é possivel **criar uma conta** pessoal e ter **conversas privadas** com outros usuários. Ou **conversar em grupo** com varios usuários ao mesmo tempo.
...
O design desse projeto foi criado no **Figma** inspirado em algumas redes sociais, principalmente o **WhatsApp**. E você pode acessá-lo através [deste link][figma-design-url].
...
## 📚 Documentação
 ...
 Você pode conferir a documentação do backend [neste arquivo][documentacao-url].
...
[license-url]: https://github.com/MBrayanS/lapislazuli-chat/blob/refactor-to-typescript/LICENSE
...
[padrao-de-commit-url]: https://github.com/MBrayanS/lapislazuli-chat/blob/refactor-to-typescript/docs/contribution/commits.md
[documentacao-url]: https://github.com/MBrayanS/lapislazuli-chat/blob/refactor-to-typescript/docs/documentation/documentacao.md
